...
public class ChannelUtils {
	...
	private static final String CHANNEL_DEFAULT = "web";
	...
	public static String getChannel(){
		return getChannel(HTApplication.getContext(), CHANNEL_DEFAULT);
	}
	...
	private static void saveChannelInSP(Context context, String channel){
        SharedPreferencesUtils.put(PREF_KEY_CHANNEL, channel);
        SharedPreferencesUtils.put(PREF_KEY_CHANNEL_VERSION, getVersionCode(context));
	}
	...
	private static String getChannelFromSP(Context context){
		...
		int versionCodeSaved = SharedPreferencesUtils.getInt(PREF_KEY_CHANNEL_VERSION, -1);
		...
		return SharedPreferencesUtils.getString(PREF_KEY_CHANNEL, "");
	}
